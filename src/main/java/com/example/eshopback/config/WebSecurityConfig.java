...
//1) Spring Security - для авторизаций
//2) Spring JPA - для работы с БД, использует технологию Hibernate
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAfter(new JwtTokenVerifier(secretKey, HttpHeaders.AUTHORIZATION, tokenPrefix, objectMapper, authenticationManager(), tokenService, userDetailsService),JwtUsernameAndPasswordAuthenticationFilter.class)
                .authorizeRequests()
